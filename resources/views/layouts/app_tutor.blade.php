...
<body>
    ...
    <aside class="sidebar">
        <div>
            ...
            <ul class="nav-menu">
                <li class="nav-item {{ request()->routeIs('tutor.home') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('tutor.sessions') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('tutor.earnings') ? 'active' : '' }}">
                    <a href="{{ route('tutor.earnings') }}">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                        Earnings
                    </a>
                </li>
            </ul>
        ...
        <div class="sidebar-footer">
            <div class="nav-item {{ request()->routeIs('tutor.profile') ? 'active' : '' }}">
